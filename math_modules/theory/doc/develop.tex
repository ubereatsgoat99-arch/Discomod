...
In most garbage collections, the list components are not inspected
...
\fun{GEN}{veccatselapply}{void *Ep, long (*p)(void* E, GEN x), void *E, GEN (*f)(void* E, GEN x), GEN A}
implements \kbd{concat([a(x)|x<-b,c(x)])}.
...
\fun{void}{pari_init_ellcondfile}{}
...
garbage on the PARI stack using \kbd{gc\_GEN} on the \kbd{out} array and
